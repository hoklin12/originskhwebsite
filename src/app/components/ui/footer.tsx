...
//   return (
//     <footer className="bg-black pb-8 text-gray-500 overflow-x-hidden px-8 md:px-8">
...
//                 <button 
//                   type="submit"
//                   className="flex items-center px-6 py-3 bg-white text-black rounded-full font-bold hover:bg-orange-400 hover:text-white transition-colors text-sm md:text-base"
//                   disabled={isLoading}
//                 >
//                   {isLoading ? (
//                     "Subscribing..."
    ...
    <footer className="bg-black pb-8 text-gray-500 overflow-x-hidden px-8 md:px-8">
      <div className="w-full">
        ...
        <div className="grid grid-cols-12 gap-4 md:gap-8 w-full">
          ...
          <div className="col-span-12 md:col-span-5 flex flex-col md:flex-row items-start gap-6 mb-8 md:mb-0">
            {/* Big logo on left */}
