  ...
  return (
    <section id="intro" className="min-h-screen bg-white m-0 py-0">
      ...
      <div className="text-center mb-4 px-4 sm:px-8">
        <h2 className="text-4xl sm:text-5xl font-normal mb-6 text-black" style={{ fontFamily: "DM Serif Text" }}>
          We are a creative agency
          <br />
          helping brands revive their dreams
        </h2>
      ...
      <div className="text-center px-4 sm:px-8">
        <Link
          href="/portfolio"
          className="bg-orange-500 text-white rounded-full px-6 py-3 font-light inline-flex items-center gap-3 hover:bg-orange-600 transition-colors duration-300"
        >
          View All Work
          <ArrowRight size={18} />
        </Link>
